        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username"><?echo"$_SESSION['usuario']"; ?> </span>
                            <b class="caret"></b>
                        </a>
       ...
       <section class="panel">
            ...
            <header class="panel-heading">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="post" action="inserir_pais.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="telefone" maxlength="14" placeholder="telefone" ">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" >CPF</label>
                    <div class="col-sm-10">
                      <input class="form-control" id="focusedInput" name="cpf" type="text" maxlength="14" placeholder="CPF">
                    </div>
                  </div>
                  <div class="form-group">
