...
$executa = $db->prepare("SELECT * FROM professor WHERE cod_professor=:cod_professor");
      ...
      <section class="wrapper ">
       ...
       <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal " action="editar_prof.php" method="post" id="jsonForm">
       ...
       <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal " data-spy="scroll" data-target="#senha" action="alterar_senha_prof.php" method="post" id='jsonForm2'>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="password" name="alterar_senha" class="form-control">
                    </div>
            ...
            <input type="submit" value="Salvar"  id="submit" class="btn btn-primary btn-lg btn-block"> 
                 </form>
