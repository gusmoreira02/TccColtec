...
<section id="main-content">
    ...
    <thead>
      <tr>
        <th data-column-id="cod_cad_aluno" data-type="numeric" id='identifier'> ID</th>
...
<script>
  ...
  $(document).ready(function(){
      var grid = $("#grid-data-api").bootgrid({
          ajax: true,
          url: "mod_select_alunos.php",
          formatters: {
              "commands": function(column, row)
              {
                  return "<button type=\"button\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.cod_cad_aluno + "\"><span class=\"glyphicon glyphicon-plus\"></span></button> " + 
                      "<button type=\"button\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.cod_cad_aluno + "\"><span class=\"glyphicon glyphicon-pencil\"></span></button>";
              }
          }
      ...
      $('#myModal').on('show.bs.modal', function (event) {
          var url = "relatorio_aluno_json.php?id=" + id;
          ...
          $.getJSON(url, function(data){
              ...
              modal.find('.modal-body').html('Responsável: ' + data.resultado)
