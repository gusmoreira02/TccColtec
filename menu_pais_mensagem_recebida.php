...
<?php   
              ...
              $executa = $db->prepare("SELECT mensagem.*, professor.nome FROM mensagem  inner join professor  WHERE mensagem.professor_cod_professor=professor.cod_professor and responsavel_cod_responsavel=:responsavel_cod_responsavel and destinatario='responsavel' ");
              $executa->bindParam(':responsavel_cod_responsavel',$_SESSION['cod_responsavel']);
              $executa->execute();
