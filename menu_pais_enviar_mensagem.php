          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="badge bg-important">
                              <?php
                                $executa = $db->prepare("SELECT * FROM mensagem WHERE responsavel_cod_responsavel=:responsavel_cod_responsavel and visualizado='nao' and destinatario='responsavel' ");
                               $executa->bindParam(':responsavel_cod_responsavel',$_SESSION['cod_responsavel']);
              $executa->execute();
echo  $executa->rowcount();
?>
                            </span>
                        </a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="menu_pais_enviar_mensagem.php">Enviar Mensagem</a></li>
              <li><a class="" href="menu_pais_mensagem_recebida.php">Mensagens recebidas</a></li>
            </ul>
        </ul>
        <!-- sidebar menu end-->
      </div>
          ...
          <div class="col-lg-12">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal" action="inserir_mensagem_pais.php"  method="post">

                  <div class="form-group">
                    <label class="col-sm-2 control-label">Enviar Para</label>
                    <div class="col-sm-10">
                      <select name="professor_nome" class="form-control styled" id="professor_nome">
                        
                        <?php
                        $resultado = $db->query("SELECT cod_professor,nome FROM professor");

 
                        while($linha=$resultado->fetch(PDO::FETCH_OBJ)){
                          

                         echo "<option value='{$linha->cod_professor}'>{$linha->nome}</option>"   ;                    
                           }
                        ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" cols="200" rows="6" placeholder="Mensagem" name="mensagem">
                      </textarea>
                    </div>
                  </div>
                  </div>
